    ...
    <>
      <div className='p-4 xl:p-10 pt-20 xl:mt-20 flex justify-evenly items-center w-screen'>
        <div className=' w-[40%] flex flex-col'> 
          ...
          <div className='xl:mt-2 mt-1 text-sm xl:text-lg'>A Powerful Premium Tool by <b>Digismiths</b></div>
        ...
        <img src="/zoho-widget-user-guide/hero.png" className='h-44 w-44 xl:h-96 xl:w-96' alt='logo' width={500} height={500}/>
      </div>
    </>
  )
}
